...
const char* ssid = "PC-Faster-2761";
...
void setup() {
 ...
 void loop() {
  Serial.println();
  HTTPClient http;
  http.begin("https://pacific-plains-60099.herokuapp.com/text.txt", "08:3B:71:72:02:43:6E:CA:ED:42:86:93:BA:7E:DF:81:C4:BC:62:30");
